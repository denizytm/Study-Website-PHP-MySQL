    ...
    <div class="top-inner-container">
        ...
        <ul class="progress-container">
            ...
            <li class="progress-data">
                ...
                <div class="percentage-container">
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" style="width: <?php echo intval(($currentUser['trueExample'] + $currentUser['falseExample']) *1.8) ?>%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress-text">
                        <?php echo intval(($currentUser['trueExample'] + $currentUser['falseExample']) *1.8) ?>%
                    </div>
                </div>
                <div class="text">
