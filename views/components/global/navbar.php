    ...
    <?php if($currentUser) : ?>
        <div class='logged-account-container' id='user-logo-container' >
            <div class='image-container' id='image-container' >
                <img src=' <?php echo $currentUser['userImage'] ?> ' class='user-logo' id='user-logo' />
            ...
            <div class='user-menu' id='user-menu-container'>
                <div class='image-username-container'>
                    <img class='image' src= ' <?php echo $currentUser['userImage'] ?> ' />
                    <div class='level-username-container' >
                        <p> <?php echo $currentUser['username'] ?> </p>
                        <div class='level' >
                            <p class='level-text' >Level  <?php echo $currentUser['level'] ?> </p>
                            <div class="progress" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                <div class="progress-bar bg-success" style="width: <?php echo intval($currentUser['levelProgress'] / $currentUser['nextLevelBound'] * 100) ?>%"><?php echo intval($currentUser['levelProgress'] / $currentUser['nextLevelBound'] * 100) ?>%</div>
                            </div>
                        </div>
                    </div>
                </div>
