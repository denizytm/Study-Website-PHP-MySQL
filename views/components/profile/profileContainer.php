                        ...
                        <div class='card'>
                            <div class='card-body'>
                                ...
                                <div class='progress mb-3'>
                                    <div class='progress-bar' role='progressbar' style='width: <?php echo $studies[0] ?>%' aria-valuenow='<?php echo $studies[0] ?>' aria-valuemin='0' aria-valuemax='100'></div>
                                </div>
                                <p>Css</p>
                                <div class='progress mb-3'>
                                    <div class='progress-bar' role='progressbar' style='width: <?php echo $studies[1] ?>%' aria-valuenow='<?php echo $studies[1] ?>' aria-valuemin='0' aria-valuemax='100'></div>
                                </div>
                                <p>Javascript</p>
                                <div class='progress mb-3'>
                                    <div class='progress-bar' role='progressbar' style='width: <?php echo $studies[2] ?>%' aria-valuenow='<?php echo $studies[2] ?>' aria-valuemin='0' aria-valuemax='100'></div>
                                </div>
                                <p>C</p>
                                <div class='progress mb-3'>
                                    <div class='progress-bar' role='progressbar' style='width: <?php echo $studies[3] ?>%' aria-valuenow='<?php echo $studies[3] ?>' aria-valuemin='0' aria-valuemax='100'></div>
                                </div>
                                <p>Cpp</p>
                                <div class='progress mb-3'>
                                    <div class='progress-bar' role='progressbar' style='width: <?php echo $studies[4] ?>%' aria-valuenow='<?php echo $studies[4] ?>' aria-valuemin='0' aria-valuemax='100'></div>
                                </div>
                                <p>Python</p>
                                <div class='progress mb-3'>
                                    <div class='progress-bar' role='progressbar' style='width: <?php echo $studies[5] ?>%' aria-valuenow='<?php echo $studies[5] ?>' aria-valuemin='0' aria-valuemax='100'></div>
                                </div>
                            </div>
                        </div>
                    </div>
