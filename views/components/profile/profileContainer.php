                ...
                <div class='card user-image-container'>
                    <div class='card-body'>
                        <div class='d-flex flex-column align-items-center text-center'>
                            <img id="userImage" src='<?php echo $userData['image'] ?? "./views/assets/person.png" ?>' class='rounded-circle p-1 user-image'>
                            <div class='mt-3'>
                                <h4><?php echo $userData['firstName'] ?> <?php echo $userData['lastName'] ?></h4>
