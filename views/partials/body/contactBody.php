...
<div class="contact-container">
    <div class="top-side">
        <div class="title">
            <h1>Contact Us</h1>
            <img src=" <?php echo publicImage("message.png") ?> " alt="">
        </div>
        <div class="top-side-inner-container">
            <div class="image">
                <img src=" <?php echo publicImage("contact.gif") ?> ">
            </div>
            <?php if(!isset($_COOKIE["login-data"])) : ?>    
                <div class='contact-container'>
    ...
    <div class="bot-side" >
        <div class="title">
            <h1>Where are we ?</h1>
            <img src=" <?php echo publicImage("location.png") ?> " alt="">
        </div>
        <div class="bot-side-inner-container">
            ...
            <div class="image">
                <img src=" <?php echo publicImage("istinyeUniFoto.png") ?> ">
            </div>
        </div>
    </div>
</div>
