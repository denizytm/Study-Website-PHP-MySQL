...
function getUserByID($id) {
    $userData = query("
        SELECT userID, username, firstName, lastName, email, image, level, totalPost, html, css, javascript, c, cpp, python, totalAnswers, profileViews
        FROM users 
        WHERE userID = :userID",[
            "userID" => $id
        ]
...
function submitAnswer($userImage,$username,$answer,$questionID){
    echo $questionID;
    if (query("
        INSERT INTO answers
