...
function getUserByID($id) {
    $userData = query("
        SELECT userID, username, firstName, lastName, email, userImage, profileViews, totalAnswers, totalPost, levelProgress, nextLevelBound, level, html, css, javascript, c, cpp, python
        FROM users 
        WHERE userID = :userID",[
            "userID" => $id
        ]
