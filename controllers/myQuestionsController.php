...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if(!$errors){
        if (move_uploaded_file($file_tmp, "$target_directory/$file_name")) {
            postQuestion($currentUser['username'],$_POST['title'],$_POST['content'],$_POST['tags'],$currentUser['userImage'],"$target_directory/$file_name");
        }else 
            postQuestion($currentUser['username'],$_POST['title'],$_POST['content'],$_POST['tags'],$currentUser['userImage'],"");
    }
