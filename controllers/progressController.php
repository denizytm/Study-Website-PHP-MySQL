...
$userLanugageData = [
    "html" => $currentUser['html'],
    "css" => $currentUser['css'],
    "javascript" => $currentUser['javascript'],
    "c" => $currentUser['c'],
    "cpp" => $currentUser['cpp'],
    "python" => $currentUser['python']
];

$total = 0;

foreach($userLanugageData as $data) $total+= $data;

$totalStudyProgress = intval($data / 6);
